# UI SOUR｜Order・方向表・素材ノブ対応

このページは、UI SOUR R8 v0.99 の上演に必要な  
**Order（仕込み順）**、**方向表（T表）**、**素材とノブの対応関係**をまとめたものです。  
ここだけを参照しても演奏を進められるように構成されています。

---

## 素材とノブの対応関係

UI SOUR では、飲料素材とシンセサイザーのノブが一対一で対応する。  
...
👉 このページのみで、UI SOUR の基盤的ルールを参照しながら上演可能。
