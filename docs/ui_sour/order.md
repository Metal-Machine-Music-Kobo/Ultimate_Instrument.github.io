# UI SOUR｜Composition・方向表・素材ノブ対応

このページは、**Composition（仕込み順）**、**方向表（T表）**、**素材とノブの対応関係**をまとめたものです。  
...
Composition とは、素材投入やノブ操作を進める基準となる並び順である。  
初期 Composition はダイス等で決定し、以降は TF による更新で回転・累積される。
...
**更新規則**  
- 各サイクル末の TF（±1/5）により Composition が回転。  
- サイクル進行は直前 Composition を基準とし、累積的な位相ずれが演奏を変化させ続ける。  
...
- **Composition**：仕込み順は3種、TFによって更新の可能性あり。  
