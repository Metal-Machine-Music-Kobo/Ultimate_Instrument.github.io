...
## 4. 歴史的参照点
- 電子音楽やライブ・エレクトロニクスにおける音響フィードバックは、RNTの原理を具体的に体現する。  
- デイヴィッド・チュードアの《Rainforest》やアンプのハウリングは、フィードバックを「生成契機」として積極的に活用した例である。  
- これらはフィードバックを単なる技術現象ではなく、**生成原理としての音楽的実践**に結びつけた。  
